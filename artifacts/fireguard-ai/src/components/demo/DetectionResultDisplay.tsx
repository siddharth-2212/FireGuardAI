...
import type { DetectionResult } from "@workspace/api-client-react/src/generated/api.schemas";
 ...
 *   2. Running — mutation is in-flight (handled by parent hiding this)
 *   3. Result — fire or clear verdict with confidence meter
 *
 * The glow ring is implemented with a blur overlay behind the circle
 * rather than box-shadow, which renders more consistently across browsers.
 */
