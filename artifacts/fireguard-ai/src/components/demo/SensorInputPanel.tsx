 ...
 * Max values were chosen to cover both normal and extreme incident scenarios:
...
function SliderRow({ label, displayValue, displayClass, sliderValue, onChange, max, step, testId }: SliderRowProps) {
  return (
