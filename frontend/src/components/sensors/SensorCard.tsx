 ...
 * Shows all four readings with progress bars so operators
    ...
    <motion.div variants={{ hidden: { opacity: 0, scale: 0.95 }, show: { opacity: 1, scale: 1 } }}>
      <Card className="glass-card h-full group hover:border-primary/30 transition-colors">
        ...
        <CardContent className="space-y-6">
          <div className={`w-full py-2 px-3 rounded-md border text-center font-semibold text-sm tracking-wider uppercase ${riskBadgeClass}`}>
